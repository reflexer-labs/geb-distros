...
DECLARE StartDate DEFAULT TIMESTAMP("2022-01-15 12:50:00+00");                 -- UTC date, Set it to when to start to distribute rewards
DECLARE CutoffDate DEFAULT TIMESTAMP("2023-02-15 12:50:00+00");                -- UTC date, Set it to when to stop to distribute rewards
DECLARE TokenOffered DEFAULT 620e18;                                              -- Number of FLX to distribute in total
