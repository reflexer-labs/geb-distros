...
DECLARE StartDate DEFAULT TIMESTAMP("2024-01-15 12:50:00+00");                 -- UTC date, Set it to when to start to distribute rewards
DECLARE CutoffDate DEFAULT TIMESTAMP("2024-02-15 12:50:00+00");                -- UTC date, Set it to when to stop to distribute rewards
