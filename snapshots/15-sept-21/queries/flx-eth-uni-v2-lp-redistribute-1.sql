DECLARE TokenAddress DEFAULT "0x353efac5cab823a41bc0d6228d7061e92cf9ccb0";     -- ERC20 to incentivise
DECLARE DeployDate DEFAULT TIMESTAMP("2021-08-02 00:00:00+00");                -- UTC date, Set it to just before the first ever LP token mint
DECLARE StartDate DEFAULT TIMESTAMP("2021-08-15 12:50:00+00");                 -- UTC date, Set it to when to start to distribute rewards
DECLARE CutoffDate DEFAULT TIMESTAMP("2021-09-01 12:50:00+00");                -- UTC date, Set it to when to stop to distribute rewards
DECLARE TokenOffered DEFAULT 1090.168146133e18;                                              -- Number of FLX to distribute in total
