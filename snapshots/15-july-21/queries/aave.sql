-- Config 
DECLARE StartDate DEFAULT TIMESTAMP("2021-06-23 12:50:00+00"); -- UTC date, Set it to when to start to distribute rewards
...
DECLARE TokenOffered DEFAULT 1430e18; -- Number of FLX to distribute in total
