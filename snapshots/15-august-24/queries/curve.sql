...
DECLARE StartDate DEFAULT TIMESTAMP("2024-07-15 12:50:00+00");                 -- UTC date, Set it to when to start to distribute rewards
DECLARE CutoffDate DEFAULT TIMESTAMP("2024-08-15 12:50:00+00");                -- UTC date, Set it to when to stop to distribute rewards
