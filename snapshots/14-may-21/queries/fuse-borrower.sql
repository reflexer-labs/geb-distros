...
DECLARE StartDate DEFAULT TIMESTAMP("2021-04-14 12:50:00+00"); -- UTC date, Set it to when to start to distribute rewards
...
DECLARE TokenOffered DEFAULT 435e18; -- Number of FLX to distribute in total
