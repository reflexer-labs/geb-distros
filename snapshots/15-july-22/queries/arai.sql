DECLARE TokenAddress DEFAULT "0xc9bc48c72154ef3e5425641a3c747242112a46af";     -- ERC20 to incentivise
DECLARE DeployDate DEFAULT TIMESTAMP("2021-06-19 00:00:00+00");                -- UTC date, Set it to just before the first ever LP token mint
DECLARE StartDate DEFAULT TIMESTAMP("2022-06-15 12:50:00+00");                 -- UTC date, Set it to when to start to distribute rewards
DECLARE CutoffDate DEFAULT TIMESTAMP("2022-07-15 12:50:00+00");                -- UTC date, Set it to when to stop to distribute rewards
DECLARE TokenOffered DEFAULT 1e18;                                              -- Number of FLX to distribute in total
